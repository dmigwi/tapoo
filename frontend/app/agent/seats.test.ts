...
describe("agent seats", () => {
  ...
  it("names the seat tooltip after the agent's current efficiency rank, capitalized, once stats are tracked", () => {
    ...
    const backtrackerAgent = { ...agent(2, "Kora"), gameLevel: 4, turnCount: 2, decayUnitsCharged: 2 }
    ...
    const navigatorAgent = { ...agent(2, "Kora"), gameLevel: 4, turnCount: 1, decayUnitsCharged: 1 }
    ...
    const trailblazerAgent = { ...agent(2, "Kora"), gameLevel: 4, turnCount: 2, decayUnitsCharged: 2 }
  ...
  it("includes the capitalized efficiency rank in the manage dialog title once stats are tracked", () => {
    const trailblazerAgent = { ...agent(2, "Katara"), gameLevel: 5, turnCount: 2, decayUnitsCharged: 2 }
  ...
  it("includes the capitalized efficiency rank in the active-player label once stats are tracked", () => {
    const navigatorAgent = { ...agent(3, "Katara"), gameLevel: 5, turnCount: 1, decayUnitsCharged: 1 }
