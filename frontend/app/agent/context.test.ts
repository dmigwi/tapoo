...
const expectedAgentPrompt = [
  ...
  "Your objective is to reach destinationCell. cellType start-cell and target-cell label the start and destination cells respectively. Each turn, prioritize an openMoves neighbor from currentCell whose alreadyExplored is false before weighing distance to destinationCell, unless currentCell's cellType is dead-end. Only dead-end should trigger backtracking.",
