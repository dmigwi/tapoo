...
export function getGameElements(): Elements | null {
  ...
  return {
    ...
    agentConfigApiVersionField: mustElement<HTMLElement>("agent-config-api-version-field"),
    agentConfigApiVersion: mustElement<HTMLInputElement>("agent-config-api-version"),
