...
export function getWallCharacters(weight: WallWeight): [string, string, string] {
...
export function getMazeDimensions(level: number, terminalSize: BaseDimensions): LevelDimensions | null {
...
export function generateMaze(dimensions: BaseDimensions, weight: WallWeight): RoundState {
  const totalCells = dimensions.length * dimensions.width;
...
export function reweightMaze(data: string[][], currentWeight: WallWeight): string[][] {
